...
import com.android.capture.utils.JSONUtils;
...
//                            Method getRetweeted_status = StatusClass.getMethod("getRetweeted_status");
//                            Object listMessage.get(i) = (Object) getRetweeted_status.invoke(listMessage.get(i), new Object());
//                            log("getStatuses=========" + listMessage.get(i));
                            //信息来源，手机weibo,还是其他平台
...
//
                            ...
                            Method getFormatSourceDetail = StatusClass.getMethod("getFormatSource");
                            ...
                            Method getFormatSourceDesc = StatusClass.getMethod("getFormatSourceDesc");
                            String formatSourceDesc = (String) getFormatSourceDesc.invoke(listMessage.get(i), new Object[]{});
                            log("getFormatSourceDesc:::::::::" + formatSourceDesc); //
...
//
                            ...
                            Method getVisible = StatusClass.getMethod("getVisible");
                            Object visible = (Object) getVisible.invoke(listMessage.get(i), new Object[]{});
                            log("getVisible:::::::::" + visible);
//                            if (null!=visible)
//                            {

//                                Method getList_id = StatusClass.getMethod("getList_id");
//                                String list_id = (String) getList_id.invoke(listMessage.get(i), new Object[]{});
//                                log("getList_id:::::::::" + list_id);


//                                Method getType = StatusClass.getMethod("getType");
//                                int type = (int) getType.invoke(listMessage.get(i), new Object[]{});
//                                log("getType:::::::::" + type);
//                            }
...
////
//
                                    Method getActionLog = MblogCardClass.getMethod("getActionLog");
                                    String actionLog = (String) getActionLog.invoke(urlList.get(j), new Object[]{});
                                    log("getActionLog:::::::::" + actionLog);
